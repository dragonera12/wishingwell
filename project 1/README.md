...
3.  Configure environment variables:
    ...
    VITE_CONTRACT_ADDRESS=CDEFXKMTD2SESHCNAM3HDQE4LFVNLKD7IX7V7SL5KF6NHQYTA2NPEH6X
    ```

## 📜 Smart Contract Details

The Wishing Well is now powered by a Soroban smart contract on the Stellar Testnet.

| Component | Address |
|-----------|---------|
| **Wishing Well Contract** | `CDEFXKMTD2SESHCNAM3HDQE4LFVNLKD7IX7V7SL5KF6NHQYTA2NPEH6X` |
| **Status** | Active |
